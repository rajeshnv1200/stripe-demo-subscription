...
const mongoOptions = {
  ...
  tlsInsecure: true // Temporarily bypass certificate validation (not recommended for production)
};
...
app.post("/create-stripe-session-subscription", async (req, res) => {
  const userEmail = "rajeshnv1200@gmail.com"; // Replace with actual user email
  let customer;
